...
import (
	...
	"github.com/dougbtv/surveyor-cni/pkg/client/clientset/versioned/scheme"
...
func (c *K8sV1Client) InterfaceMaps(namespace string) InterfaceMapInterface {
	return newInterfaceMaps(c, namespace)
}
